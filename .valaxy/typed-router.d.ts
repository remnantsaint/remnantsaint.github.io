...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/posts/algo/迭代-递归-分治': RouteRecordInfo<'/posts/algo/迭代-递归-分治', '/posts/algo/迭代-递归-分治', Record<never, never>, Record<never, never>>,
    ...
    '/posts/question/linked-list/对链表插入排序': RouteRecordInfo<'/posts/question/linked-list/对链表插入排序', '/posts/question/linked-list/对链表插入排序', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/反转部分链表': RouteRecordInfo<'/posts/question/linked-list/反转部分链表', '/posts/question/linked-list/反转部分链表', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/反转链表': RouteRecordInfo<'/posts/question/linked-list/反转链表', '/posts/question/linked-list/反转链表', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/合并有序链表': RouteRecordInfo<'/posts/question/linked-list/合并有序链表', '/posts/question/linked-list/合并有序链表', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/回文数': RouteRecordInfo<'/posts/question/linked-list/回文数', '/posts/question/linked-list/回文数', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/链表排序': RouteRecordInfo<'/posts/question/linked-list/链表排序', '/posts/question/linked-list/链表排序', Record<never, never>, Record<never, never>>,
    '/posts/question/linked-list/删除链表的倒数第N个结点': RouteRecordInfo<'/posts/question/linked-list/删除链表的倒数第N个结点', '/posts/question/linked-list/删除链表的倒数第N个结点', Record<never, never>, Record<never, never>>,
    ...
    '/posts/talk/冰冷的离别——姬野星奏的三次选择': RouteRecordInfo<'/posts/talk/冰冷的离别——姬野星奏的三次选择', '/posts/talk/冰冷的离别——姬野星奏的三次选择', Record<never, never>, Record<never, never>>,
