...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/posts/DFS-搜索': RouteRecordInfo<'/posts/DFS-搜索', '/posts/DFS-搜索', Record<never, never>, Record<never, never>>,
    '/posts/DFS（图论）': RouteRecordInfo<'/posts/DFS（图论）', '/posts/DFS（图论）', Record<never, never>, Record<never, never>>,
    ...
    '/posts/valaxy建站': RouteRecordInfo<'/posts/valaxy建站', '/posts/valaxy建站', Record<never, never>, Record<never, never>>,
